...
import { Button, FormLabel, HStack, Spacer, Switch, Textarea } from "@chakra-ui/react"
  ...
  return (
    <Layout>
      {dataStoreUser && dataStoreUser.membership!.current >= 5 && <>
        <HStack w='full'>
          <Spacer />
          <FormLabel htmlFor='enable-gpt4' mb='0' sx={{_hover: {cursor: 'pointer'}}}>
            Enable Advanced AI?
          </FormLabel>
          <Switch  
            colorScheme='teal' 
            ...
            onChange={ e => setEnableGPT4((e.target as HTMLInputElement).checked)} 
          />
        </HStack>
        <Textarea
          as={ResizeTextarea}
