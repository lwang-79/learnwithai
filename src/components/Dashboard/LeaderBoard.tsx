...
function LeaderBoard() {
  const [yesterdayMathRankingItem, setYesterdayMathRankingItem] =
    useState<RankingItem>();
  const [lastMonthMathRankingItem, setLastMonthMathRankingItem] =
    useState<RankingItem>();
  const [thisMonthMathRankingItem, setThisMonthMathRankingItem] =
    useState<RankingItem>();
  const [yesterdayWritingRankingItem, setYesterdayWritingRankingItem] =
    useState<RankingItem>();
  const [lastMonthWritingRankingItem, setLastMonthWritingRankingItem] =
    useState<RankingItem>();
  const [thisMonthWritingRankingItem, setThisMonthWritingRankingItem] =
    useState<RankingItem>();
            ...
            <VStack>
              ...
              {[0, 1, 2].map((name, index) => (
                <Tag
                  ...
                  w="full"
                >
                  <HStack px={4} py={1} spacing={4} w="full">
                    <Icon
                      as={Medal}
                      boxSize={6}
                      color={
                        index === 0 ? "gold" : index === 1 ? "silver" : "orange"
                      }
                    />
                    <Text fontWeight="extrabold">
                      {yesterdayMathRankingItem?.names[index]}
                    </Text>
                    <Spacer />
                    <Text fontWeight="extrabold">
                      {yesterdayMathRankingItem?.values[index]}
                    </Text>
                  </HStack>
                </Tag>
              ))}
            ...
            <VStack>
              <HStack>
                ...
                <VStack spacing={0}>
                  ...
                  <Text fontSize="xs" color="blue.400">
                    {yesterdayWritingRankingItem?.date}
                  </Text>
                </VStack>
                <Icon as={TrophyCup} boxSize={8} color="orange" />
              </HStack>
              ...
              {[0, 1, 2].map((name, index) => (
                ...
                >
                  <HStack px={4} py={1} spacing={4} w="full">
                    ...
                    />
                    <Text fontWeight="extrabold">
                      {yesterdayWritingRankingItem?.names[index]}
                    </Text>
                    <Spacer />
                    <Text fontWeight="extrabold">
                      {yesterdayWritingRankingItem?.values[index]}
                    </Text>
                  </HStack>
                </Tag>
              ))}
              ...
              <Table size="sm">
                ...
                <Tbody>
                  {[1, 2, 3, 4, 5].map((name, index) => {
                    return (
                      <Tr key={`${name}-${index}`}>
                        <Td py={0}>
                          <Tag rounded="full" colorScheme="pink">
                            {name}
                          </Tag>
                        </Td>
                        <Td>{thisMonthMathRankingItem?.names[index] ?? "-"}</Td>
                        <Td isNumeric>
                          {thisMonthMathRankingItem?.values[index] ?? "-"}
                        </Td>
                      </Tr>
                    );
                  })}
                ...
                <Tfoot>
                  <Tr>
                    ...
                    <Th>
                      <VStack>
                        <Text>{thisMonthMathRankingItem?.date ?? "-"}</Text>
                      </VStack>
                    </Th>
                    <Th></Th>
                  </Tr>
              ...
              <Table size="sm">
                  ...
                  {[1, 2, 3, 4, 5].map((name, index) => {
                    return (
                      <Tr key={`${name}-${index}`}>
                        ...
                        <Td>
                          {thisMonthWritingRankingItem?.names[index] ?? "-"}
                        </Td>
                        <Td isNumeric>
                          {thisMonthWritingRankingItem?.values[index] ?? "-"}
                        </Td>
                      </Tr>
                    );
                  })}
                ...
                <Tfoot>
                  <Tr>
                    ...
                    <Th>
                      <VStack>
                        <Text>{thisMonthWritingRankingItem?.date ?? "-"}</Text>
                      </VStack>
                    </Th>
                    <Th></Th>
                  </Tr>
