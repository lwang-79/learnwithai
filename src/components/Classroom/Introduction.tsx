  ...
  return (
    <VStack w='full'>
      ...
      <HStack spacing={4} p={4}>
        ...
        <Tag p={4} colorScheme='blue'>{`Hello I am Mr. Furgerson, I'm excited to be here and looking forward to getting to know each one of you! Don't forget, you have the option to set the class duration using the round option and can pause the class if it becomes too fast-paced for you.`}</Tag>
      </HStack>
    </VStack>
  )
}
