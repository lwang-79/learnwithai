...
Write a creative narrative including the sentence "[random sentence]".`
  ...
  return `
Generate a narrative writing prompt for a ${level} level student in a topic about ${topics[randomIndex1][randomSubIndex1]} and ${topics[randomIndex2][randomSubIndex2]}.
